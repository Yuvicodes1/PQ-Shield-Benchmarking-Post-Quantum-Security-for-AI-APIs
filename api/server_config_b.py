"""Configuration B protected API: ML-KEM-768 + ECDSA P-256."""
...
from crypto.config_b_hybrid import HybridChannel
...
app = FastAPI(title="PQ-Shield Configuration B", version="0.1.0", lifespan=lifespan)
...
def health() -> dict[str, str]:
    return {"status": "ok", "configuration": "B-hybrid"}
...
def handshake() -> HandshakeResponse:
    ...
    return HandshakeResponse(
        kem_public_key=b64(kem_public_key), signing_public_key=signing_public_key,
